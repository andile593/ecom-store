...
export const newOrder = (order) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`${apiUrlReference}/order/new`, order, config);
...
export const myOrders = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${apiUrlReference}/orders/me`);
...
export const getOrderDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${apiUrlReference}/order/${id}`);
...
export const getPaymentStatus = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${apiUrlReference}/payment/status/${id}`);
...
export const getAllOrders = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${apiUrlReference}/admin/orders`);
...
export const updateOrder = (id, order) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`${apiUrlReference}/admin/order/${id}`, order, config);
...
export const deleteOrder = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`${apiUrlReference}/admin/order/${id}`);
